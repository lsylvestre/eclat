(* $ make SRC="benchs/queens/sans-collect/queens2.ml"  FLAGS="-ocaml" BCOPT="-load-code -load-data" byte
   $ make SRC="benchs/queens/sans-collect/queens2.ml"  FLAGS="-ocaml" BCOPT="-load-code -load-data" vm
   $ cd ../target/ml
